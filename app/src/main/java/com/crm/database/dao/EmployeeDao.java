...
public interface EmployeeDao {
    ...
    @Query("SELECT * FROM " + Constants.TABLE_EMPLOYEE)
    LiveData<List<EmployeeEntity>> getAllEmployees();

    /*@Query("SELECT * FROM " + Constants.TABLE_EMPLOYEE + " WHERE " + Constants.EMPLOYEE_NUMBER + " = :empNumber"")
    Employee getEmloyee(String empNumber);*/
